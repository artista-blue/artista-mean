...
var AngularUtils = require('./angular_utils');
...
ArtistaMean.prototype = {
	...
	async.waterfall([
		...
		ExpressUtils.Initializer.init(that.projectPath, function (err) {
		...
		ExpressUtils.Generator.routes(modelList, tmplPath, outDir, function (err) {
		...
		ExpressUtils.Generator.app(modelList, tmplPath, outDir, function (err) {
		...
		AngularUtils.generate(modelList, tmplDir, outDir, function (err) {
